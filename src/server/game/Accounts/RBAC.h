...
enum RBACPermissions
{
    ...
    RBAC_PERM_MAX,
    RBAC_PERM_COMMAND_PARAGON_STRENGTH = 883,
    RBAC_PERM_COMMAND_PARAGON_AGILITY = 884,
    RBAC_PERM_COMMAND_PARAGON_STAMINA = 885,
    RBAC_PERM_COMMAND_PARAGON_INTELLECT = 886,
    RBAC_PERM_COMMAND_PARAGON_SPIRIT = 887,
    RBAC_PERM_COMMAND_PARAGON_STATS = 888,
    RBAC_PERM_COMMAND_PARAGON_RESET = 889,
