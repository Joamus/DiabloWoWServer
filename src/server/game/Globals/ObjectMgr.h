...
class TC_GAME_API ObjectMgr
{
    ...
    public:
        ...
        uint32 GetParagonXpForLevel(uint32 level) const;
        uint32 GetMaxParagonLevel() const;
    ...
    private:
        ...
        // This map allows you to look up the same item, just with another monster level. The pair is entry + monsterlevel
        std::unordered_map<std::pair<uint32, uint16>, ItemTemplate> _itemMonsterLevelContainer;
